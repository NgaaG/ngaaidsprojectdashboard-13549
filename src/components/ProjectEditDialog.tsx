          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="learning" className="space-y-4 mt-4">
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Define learning goals for each CMD competency
                </p>
                {(["Research", "Create", "Organize", "Communicate", "Learn"] as const).map((comp) => (
                  <div key={comp}>
                    <Label htmlFor={`goal-${comp}`} className="text-base font-semibold text-primary">
                      {comp}
                    </Label>
                    <Textarea
                      id={`goal-${comp}`}
                      ...
                      placeholder={`Enter learning goals for ${comp}...`}
                      rows={2}
                      className="mt-2"
                    />
                  </div>
            ...
            <TabsContent value="tasks" className="space-y-4 mt-4">
              <div className="flex justify-between items-center">
                <p className="text-sm text-muted-foreground">
                  Track key project tasks and their status
                </p>
              ...
              <div className="space-y-4">
                {keyTasks.map((task) => (
                  <div key={task.id} className="p-4 bg-muted/50 rounded-lg space-y-3">
